...
const HackathonsPage = () => {
  ...
  const [cardWidth, setCardWidth] = useState(350); // Default card width + gap
  ...
  useEffect(() => {
    const updateContainerWidth = () => {
      if (scrollContainerRef.current) {
        ...
        const cardWidthWithGap = 350 + 24; // 350px card + 24px gap
  ...
  const scrollLeft = () => {
    // console.log("left")
    if (scrollContainerRef.current) {
      const scrollAmount = Math.ceil(containerWidth / cardWidth) * cardWidth;
      // console.log(scrollAmount, containerWidth, cardWidth)
      ...
      <div className="relative  ">
        ...
        <div className="w-full mx-auto ">
          ...
          <motion.div
            ...
            className="text-center mb-2 relative overflow-hidden  px-4 rounded-2xl"
          >
          ...
          {/* Control Bar */}
          <div className=" max-w-[95%] mx-auto rounded-xl shadow-md p-4">
            ...
            <div className="relative">
              ...
              {filteredHackathons.length > 0 && (
                <>
                  <button
                    onClick={scrollLeft}
                    className="absolute -left-0  top-1/2 -translate-y-1/2 z-[99] p-2 rounded-full bg-white dark:bg-gray-800 shadow-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                  ...
                  <button
                    onClick={scrollRight}
                    className="absolute right-0 top-1/2 -translate-y-1/2 z-[99] p-2 rounded-full bg-white dark:bg-gray-800 shadow-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                    style={{ transform: 'translateY(-50%) translateX(50%)' }}
                  >
              ...
              <div
                ...
                className="flex gap-6 overflow-x-auto pb-6 -mx-4 px-4 snap-x snap-mandatory  justify-center items-center"
                style={{
              ...
              `}</style>
                ...
                {isLoading ? (
                  ...
                  [...Array(4)].map((_, i) => (
                    <div key={i} className="flex-shrink-0 snap-start" style={{ minWidth: '350px' }}>
                      <HackathonSkeleton />
                    </div>
                  ))
                ) : filteredHackathons.length > 0 ? (
